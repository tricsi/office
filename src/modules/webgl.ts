...
export function createTexture(gl: WebGLRenderingContext, image?: HTMLImageElement, pixelate = true): WebGLTexture {
...
export function createColor(r = 0, g = 0, b = 0, a = 1) {
...
export function setUniform(gl: WebGLRenderingContext, program: WebGLProgram, name: string, value: number | Float32Array, size?: number) {
...
export function setAttribute(gl: WebGLRenderingContext, program: WebGLProgram, name: string, size: number) {
